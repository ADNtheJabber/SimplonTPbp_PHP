...
<!--end of nav-->  
    ...
    <div class="allForms" id="allforms">
...
<form action="" class="choixClient" id="formChoixClient">
    ...
    <input type="radio" name="typeClient" id="choixPhysique"/>
    <label for="">Physique</label><br>

    <input type="radio" name="typeClient" id="choixEntreprise"/>
    <label for="">Entreprise</label>
</form>

</div>

<form action="" class="situationPro" id="formSituationPro">
...
<form action="clientPhysiqueController" class="myFormPhysique" method="POST" id="clientPhysique">
    ...
    <script src="public/js/scriptClient.js"></script>
